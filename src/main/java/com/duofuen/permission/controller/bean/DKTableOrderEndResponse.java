...
public class DKTableOrderEndResponse extends BaseResponse<DKTableOrderEndResponse.Data>{
    public DKTableOrderEndResponse() {
        super();
        this.data = new DKTableOrderEndResponse.Data();
    }
    public class Data {
        ...
        public void setDKTableOrderGoods(List<DKTableOrderGoods> goodsList){
            ...
            List<DKTableOrderEndResponse.Goods> list = new ArrayList<>();
            for(DKTableOrderGoods goods : goodsList){
                DKTableOrderEndResponse.Goods item = new DKTableOrderEndResponse.Goods();
